...
class SpecEdgeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Sync = channel.unary_unary(
                ...
                _registered_method=True)
        self.VerifyBundleAsync = channel.unary_unary(
                '/specedge.SpecEdgeService/VerifyBundleAsync',
                request_serializer=specedge__pb2.VerifyBundleRequest.SerializeToString,
                response_deserializer=specedge__pb2.VerifyBundleResponse.FromString,
                _registered_method=True)
...
class SpecEdgeServiceServicer(object):
    ...
    def VerifyBundleAsync(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SpecEdgeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'VerifyBundleAsync': grpc.unary_unary_rpc_method_handler(
                    servicer.VerifyBundleAsync,
                    request_deserializer=specedge__pb2.VerifyBundleRequest.FromString,
                    response_serializer=specedge__pb2.VerifyBundleResponse.SerializeToString,
            ),
    }
...
class SpecEdgeService(object):
    ...
    def VerifyBundleAsync(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/specedge.SpecEdgeService/VerifyBundleAsync',
            specedge__pb2.VerifyBundleRequest.SerializeToString,
            specedge__pb2.VerifyBundleResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
